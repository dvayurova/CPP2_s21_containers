...
template <class Key, class Value, class Compare>
typename RedBlackTree<Key, Value, Compare>::Node *
RedBlackTree<Key, Value, Compare>::ConstIterator::get_node() const {
  return node_;
}
...
RedBlackTree<Key, Value, Compare>::operator=(const RedBlackTree &other) {
  if (this != other) {
    root_ = copyTree(other.root_);
  }
  return *this;
...
template <class Key, class Value, class Compare>
RedBlackTree<Key, Value, Compare>::RedBlackTree(RedBlackTree &&other) {
  root_ = nil_.get();
  swap(other);
}
...
template <class Key, class Value, class Compare>
RedBlackTree<Key, Value, Compare> &
RedBlackTree<Key, Value, Compare>::operator=(RedBlackTree &&other) {
  if (this != other) {
    clear();
    swap(other);
  }
...
template <class Key, class Value, class Compare>
typename RedBlackTree<Key, Value, Compare>::size_type
RedBlackTree<Key, Value, Compare>::max_size() const {
...
std::vector<
    std::pair<typename RedBlackTree<Key, Value, Compare>::iterator, bool>>
RedBlackTree<Key, Value, Compare>::insert_many(Args &&...args) {
...
template <class Key, class Value, class Compare>
typename RedBlackTree<Key, Value, Compare>::Node *
RedBlackTree<Key, Value, Compare>::get_root() const {
  return root_;
}

template <class Key, class Value, class Compare>
void RedBlackTree<Key, Value, Compare>::printImageTree(Node *node, int depth,
                                                       char branch) {
  if (node == nil_.get())
    return;
...
template <class Key, class Value, class Compare>
void RedBlackTree<Key, Value, Compare>::printSortTree(Node *node) {
  if (node == nil_.get())
    return;
